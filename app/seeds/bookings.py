...
def seed_bookings():
    ...
    booking9 = Booking(pickup_date=datetime(2023,1,20,8,0,0), drop_off_date=datetime(2023,1,27,8,0,0), address='72 Waverly st', city='Boston', state='MA', country='USA', guest_id=2, vehicle_id=5)
