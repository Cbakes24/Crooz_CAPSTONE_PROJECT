...
def seed_bookings():
    ...
    booking8 = Booking(pickup_date=datetime(2023,3,20,8,0,0), drop_off_date=datetime(2023,3,27,8,0,0), address='300 Happy st', city='Boston', state='MA', country='USA', guest_id=6, vehicle_id=2)
